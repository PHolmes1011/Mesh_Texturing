...
void D3D12HelloTexture::LoadAssets()
{
    ...
    // Create the vertex buffer.
    {
        ...
        const UINT vertexBufferSize = sizeof(IslandMap.islandVerts);
        ...
        memcpy(pVertexDataBegin, IslandMap.islandVerts, sizeof(IslandMap.islandVerts));
...
void D3D12HelloTexture::PopulateCommandList()
{
    ...
    m_commandList->DrawInstanced(61, 1, 0, 0);
